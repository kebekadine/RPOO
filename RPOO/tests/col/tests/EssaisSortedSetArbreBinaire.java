...
public class EssaisSortedSetArbreBinaire {

	public static void main(String[] argv) {
		System.out.println("------------ Création d'un ensemble vide :");
		SortedSet<Integer> s = new SortedSetArbreBinaire<>();
...
l.toArray(t1) : [-1, 5, 8]
l.toArray(t2) : [-1, 5, 8, null, null, null]
Tableau t1    : [4]
Tableau t2    : [-1, 5, 8, null, null, null]
------------ Méthodes de Set et equals :
Parcours de { -1 5 8 9 } et suppression des entiers négatifs :
-> -1 (supprimé) -> 5 -> 8 -> 9 [fin]
Résultat : { 5 8 9 }
{ 5 8 9 } contient { 5 9 } ? true
{ 5 8 9 } contient { -1 3 5 9 } ? false
{ 5 8 9 } union { -1 3 5 9 } = { -1 3 5 8 9 }
{ 5 8 9 } inter { -1 3 5 9 } = { 5 9 }
{ 5 8 9 } diff  { -1 3 5 9 } = { 8 }
{ 5 8 9 } equals { 9 5 } ? false
{ 5 8 9 } equals { 2 8 9 5 } ? false
{ 5 8 9 } equals { 8 9 5 } ? true
------------ Méthodes de SortedSet :
Eléments de { -1 4 5 8 9 } dans [ 4 ;  8[ : { 4 5 }
Eléments de { -1 4 5 8 9 } dans [ 0 ;  5[ : { 4 }
Eléments de { -1 4 5 8 9 } dans [-1 ; 15[ : { -1 4 5 8 9 }
Min de { -1 4 5 8 9 } : -1
Max de { -1 4 5 8 9 } : 9

...
class SetChaineSimpleTEST<E> extends SetChaineSimple<E> {
	@SafeVarargs
	SetChaineSimpleTEST(E... val) {
		super();
		if (val.length > 0) {
...
public class JUnitSetChaineSimple {

	// ------------------------ Données de test

	protected SetChaineSimpleTEST<Integer> s1, s2, s3, s4;
	...
	@SafeVarargs
	private static <E> boolean valideSetChaineSimple(SetChaineSimpleTEST<E> s, E... v) {
	...
	@Before
	public void setup() {
		this.s1 = new SetChaineSimpleTEST<>();
		this.s2 = new SetChaineSimpleTEST<>(1);
		this.s3 = new SetChaineSimpleTEST<>(1,2);
		this.s4 = new SetChaineSimpleTEST<>(5,7,8,2,1);
	}
	...
	public void testIterator() {
		...
		it = this.s4.iterator();
		assertTrue(it.hasNext());
		assertSame(it.next(), 5);
		it.remove();
		assertTrue(valideSetChaineSimple(this.s4, 7, 8, 2, 1));
		assertTrue(it.hasNext());
		assertSame(it.next(), 7);
		assertTrue(it.hasNext());
		assertSame(it.next(), 8);
		it.remove();
		assertTrue(valideSetChaineSimple(this.s4, 7, 2, 1));
		assertTrue(it.hasNext());
		assertSame(it.next(), 2);
		assertTrue(it.hasNext());
		assertSame(it.next(), 1);
